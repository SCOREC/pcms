...
!PART1: used by parameters_IO
  ...
  character(len=60) :: git_branch = GIT_BRANCH
  character(len=60) :: git_master = GIT_MASTER
#else
  character(len=60) :: git_branch='', git_master=''
#endif

  character(len=13), parameter :: release = '1.8 - patch 1'
