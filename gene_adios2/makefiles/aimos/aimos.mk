...
ADIOS2 = yes
ADIOS2_DIR = $(ADIOS2_ROOT)/bin# used in rules.mk
...
INCPATHS = -I$(OPENBLAS_ROOT)/include

#LIBRARIES AND LIBFLAGS
#Insert BLAS library
LIBS = -L$(OPENBLAS_ROOT)/lib64 -lopenblas
...
ifeq ($(SCALAPACK),yes)
  LIBS += -L$(NETLIB_SCALAPACK_ROOT)/lib/ -lscalapack -lopenblas
...
ifeq ($(FUTILS),yes)
 ...
 HDF5PATH = $(HDF5_ROOT)#no space!
 HDF5_LIBPATH  = -L$(HDF5PATH)/lib -L$(FUTILSDIR) -L$(ZLIB_ROOT)/lib
