...
ifeq ($(FFTLIB),fftw)
 INCPATHS += -I/u/local/apps/fftw3/current/include
 LIBS += -L/u/local/apps/fftw3/current/lib/ -lfftw3 -lfftw3f
endif
...
# set by modules (make sure, you use the *complex* versions)
 PETSC_ARCH =
 PETSC_DIR = /u/home/d/dtold/petsc/3.5.3
 SLEPC_DIR = /u/home/d/dtold/slepc/3.5.3
...
ifeq ($(SCALAPACK),yes)
  LIBS += -L/u/local/apps/scalapack/current/intel-11.1/openmpi-1.4/libscalapack.a
endif
