...
SWIGEXPORT SwigClassWrapper _wrap_wdmcpl_create_xgc_field_adapter(SwigArrayWrapper *farg1, int const *farg2, void const **farg3, int const *farg4, int const *farg5, SwigClassWrapper *farg6, in_overlap_function farg7) {
  SwigClassWrapper fresult ;
  char *arg1 = (char *) 0 ;
  MPI_Comm arg2 ;
  void *arg3 = (void *) 0 ;
  ...
  result = (WdmCplFieldAdapterHandle *)wdmcpl_create_xgc_field_adapter((char const *)arg1,arg2,arg3,arg4,arg5,(WdmCplReverseClassificationHandle const *)arg6,arg7);
  fresult.cptr = (void*)result;
  fresult.cmemflags = SWIG_MEM_RVALUE | (0 ? SWIG_MEM_OWN : 0);
  return fresult;
}
...
SWIGEXPORT void _wrap_wdmcpl_kokkos_initialize_without_args() {
  wdmcpl_kokkos_initialize_without_args();
}


SWIGEXPORT void _wrap_wdmcpl_kokkos_finalize() {
