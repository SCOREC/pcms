...
module charge_curr_dens
  !USE aux_func
  USE communications, ONLY: MPI_IN_PLACE,MPI_COMPLEX_TYPE, MPI_SUM,mpi_comm_v,&
       &my_complex_sum_vwspec, my_complex_sum_wspec, calculate_test_sum
  USE discretization, ONLY: li0,li1,li2,pi0,pi1,pi2,lj0,lj1,lj2,pj0,pj1,pj2,&
       & lk1,lk2,ll1,ll2,lm0,lm1,lm2,ln0,ln1,ln2,&
       & lijk0,llm0,lklmn0,lijklmn0,n_spec,mype
  !USE geometry
  ...
  !USE MatrixModule
  USE par_in, ONLY: trap_pass, perf_vec,spec, only_passing,beta
  USE par_other, ONLY: n_fields,xy_local
  USE vel_space, ONLY: mem_est_calc_moments_2, mat_00_trap,mat_00,mat_10,mat_001,&
       & calc_moments, calc_moments_2, initialize_calc_moments_2, finalize_calc_moments_2
#ifdef COUPLE_XGC
  use par_poloidal_planes, only: weight
#endif
  implicit none
             ...
             Do k=lk1,lk2
                Do j=lj1,lj2
                   ...
                   densmu(li1:li2,j,k,m,n) = densmu(li1:li2,j,k,m,n) + &
                        &mat_00(:,pj1,k,l,m) * p_g_1(:,j,k,l,m,n)*weight(:)
#else
                   densmu(li1:li2,j,k,m,n) = densmu(li1:li2,j,k,m,n) + &
