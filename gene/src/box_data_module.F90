...
MODULE box_data_module
  ...
  !USE par_in, ONLY: n0_global
  !USE coordinates, ONLY: lp1
  implicit none
  private
...
CONTAINS
  ...
  SUBROUTINE box_data_initialize(this,q0, shat, mag_prof, &
            &rhostar,x0,kymin,n0_global,lp1,lilo)
    type(box_data_type) :: this
    real, intent(in) :: q0, shat, rhostar
    logical, intent(in) :: mag_prof
    REAL,INTENT(IN) :: x0,kymin,lp1
    INTEGER, INTENT(IN) :: n0_global
    LOGICAL,intent(IN) :: lilo
