...
ifeq ($(CODEMODS),no)
CODEMODS_DUMMY=dummy_
endif

F90PSRC += $(CODEMODS_DUMMY)codemods.F90
...
#all src files for codemods
ALLFULLSRC = $(wildcard $(SRCDIR)/*[.?90,.h,.c,.cpp,.?03])
ALLFULLSRC := $(filter-out $(SRCDIR)/codemods.F90, $(ALLFULLSRC))
...
$(OBJDIR)/$(CODEMODS_DUMMY)codemods.o:	$(OBJDIR)/discretization.o\
			$(OBJDIR)/par_in.o\
			$(OBJDIR)/par_other.o\
			$(OBJDIR)/file_io.o
...
$(OBJDIR)/checkpoint.o:	$(OBJDIR)/boundary.o\
			$(OBJDIR)/comm.o\
			$(OBJDIR)/discretization.o\
			$(OBJDIR)/file_io.o\
...
$(OBJDIR)/compute_dt.o:	$(OBJDIR)/antenna.o\
			$(OBJDIR)/par_mod.o\
			$(OBJDIR)/discretization.o\
			$(OBJDIR)/coordinates.o\
			$(OBJDIR)/comm.o\
...
$(OBJDIR)/diag_aux.o:	$(OBJDIR)/aux_fields.o\
			$(OBJDIR)/geometry.o\
			$(OBJDIR)/par_mod.o\
			$(OBJDIR)/vel_space.o\
			$(OBJDIR)/x_derivatives.o
...
$(OBJDIR)/tracer_IO.o:			$(FUTILSDIR)/libfutils.a
