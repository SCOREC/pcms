...
namespace coupler {
  ...
  Array2d<CV>* receive_density(const std::string cce_folder,
    ...
    return receive2d_from_ftn<CV>(cce_folder,name, io, engine,my_start,my_count,comm,m);
  }
  ...
  Array2d<double>* receive_field(const std::string cce_folder,
    ...
    return receive2d_from_ftn<double>(cce_folder,name, io, engine,my_start,my_count, comm,m);
  }
