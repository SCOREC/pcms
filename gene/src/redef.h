...
#define DEBUG_LOCAL_ON logical,parameter :: OUTPUT=.true.
#define DEBUG_LOCAL_OFF logical,parameter :: OUTPUT=.false.
#define DEBUG_OUTPUT(label,arr) if (OUTPUT) call debug_output(label,arr)
#else
#define DEBUG_LOCAL_ON
#define DEBUG_LOCAL_OFF
#define DEBUG_OUTPUT(label,arr)
#endif
...
#define sfftw_plan_dft_c2r_1d dfftw_plan_dft_c2r_1d
#define sfftw_plan_dft_r2c_1d dfftw_plan_dft_r2c_1d
