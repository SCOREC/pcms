...
module petsc_aux
  ...
  public:: pe2fo, fo2pe, initialize_petsc_mat, finalize_petsc_mat, &
       &initialize_petsc_vec, finalize_petsc_vec, initialize_petsc_flags
  public:: glob_g, glob_rhs, v0, ksp_obj, shellmat, globerr,a_mat,b_mat, impl_shift
#if (PETSC_VERSION_GE(3,8,0))
  public:: petsc_null_vec, petsc_null_mat
#else
  public:: petsc_null_object
#endif
  public:: matop_mult, different_nonzero_pattern, same_nonzero_pattern,&
       petsc_null_character, petsc_null_scalar, petsc_decide, petsc_null_integer, petsc_comm_world,&
       kspreason,petsc_t,petsc_f, KSP_DIVERGED_ITS
...
contains
  ...
  subroutine pe2fo(petg,locg)
    ...
    PERFON('pefo')
#if (PETSC_VERSION_GE(3,6,0))
    call VecGetArrayReadF90(petg,arr_point,ierr)
#else
...
#if (PETSC_VERSION_GE(3,6,0))
    call VecRestoreArrayReadF90(petg,arr_point,ierr)
#else
  ...
  subroutine initialize_petsc_mat(mat_invert)
    ...
    if ((mype==0).and.print_ini_msg) &
         ...
         & write(*,'(A,I1,A,I1,A,I1,A,I2.2)') &
#else
         & write(*,'(A,I1,A,I2,A,I1,A,I2.2)') &
#endif
         & "Using PETSc version ",&
         & PETSC_VERSION_MAJOR,'.',PETSC_VERSION_MINOR,'.',&
         & PETSC_VERSION_SUBMINOR,'-p',PETSC_VERSION_PATCH
