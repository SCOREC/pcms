...
module initcond
  ...
  USE coordinates, ONLY: kx,kxmin,kx_center,lx,ky,kymin,ly,&
       &zval,vp,lv,mu,ki,kj,kjmax,deli,lp1,xval_a,xval,x0
  ...
  USE geometry, ONLY: shat, geom, rhostar
...
contains
  ...
  Subroutine StartWave(aux_x,aux_y,aux_z,aux_amp)
    ...
    If (write_pe) Then
       ...
       If ((shat.ne.0.0).and.(kpar.ne.0.0)) Then
...
!*************************************************************************!
  ...
  Subroutine XGC_like(aux_x,aux_y,aux_z,aux_amp)
    REAL, intent(IN) :: aux_x, aux_y, aux_z, aux_amp
    COMPLEX, DIMENSION(li1:li2,lj1:lj2,lk1:lk2) :: dens
    REAL::   amplitude,sigma_i,xvar, noise_amp
    INTEGER:: i, j, k, n
    complex, dimension(li1:li2,0:nky0-1):: noise
