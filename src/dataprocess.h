...
// here, pointers must be assigned a NULL;
     ...
     CV*  densintmp=NULL;  // temporary 2d density array prepared for backward fourier transform
...
//The following parameters for yparal=true;
     ...
     void RealdataToCmplxdata3D(const Part1ParalPar3D& p1pp3d, const Part3Mesh3D& p3m3d);
     void InitFourierPlan3D(const Part1ParalPar3D& p1pp3d, const Part3Mesh3D &p3m3d);
   private:
     const bool preproc;
     const bool yparal;
     ...
     void AllocDensityArrays(const Part1ParalPar3D& p1pp3d, const Part3Mesh3D& p3m3d);
     void AllocPotentArrays(const Part1ParalPar3D& p1pp3d, const Part3Mesh3D &p3m3d);
