! Warning :: this routine has not been used for a while, so recent updates are not reflected.
attributes(device) &
subroutine derivs_sp_gpu(fld,t, ptli,  &
              sp_type, yprime, diag_on, vf_diag, tb)
  ...
  use sml_module_gpu, only : &
    ...
    sml_f0_1_lt, sml_f0_1_ln,  sml_dwdt_fix_bg,sml_dwdt_exb_only
