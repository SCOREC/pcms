...
*/
   denssend = new double*[p3.blockcount];
   for(LO i=0;i<p3.blockcount; i++){
     denssend[i] = new double[p3.lj0];
   }
 } 
}
...
*/
    potentsend = new CV*[p1.blockcount];
    for(LO i=0;i<p1.blockcount;i++){
      potentsend[i] = new CV[p1.lj0];
    }
  }
}
