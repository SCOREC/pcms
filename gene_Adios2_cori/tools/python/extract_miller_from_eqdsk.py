...
q_fine=empty((nw*10),dtype=float)
phi_fine[0]=0.
...
Z0_spl=US(r_avg,Z_avg,k=interpol_order,s=1e-5)
...
print('Coordinates: r={0:8.5g}, psi={1:8.5g}, psi_N={2:8.5g}, r/R0={3:8.5g}, rho_tor={4:8.5g}, r_maxmin={5:8.5g}'.format(r,psi,psi_N,r/R0_pos,float(rho_tor_spl(psi)),float(rmaxmin_spl(psi))))
...
drZ_spl=US(r_avg[psi_stencil],drZ,k=interpol_order,s=1e-5)
...
print('shat    = {0:9.5g} !(defined as r/q*dq_dr)'.format(r/float(q_spl(r))*q_spl.derivatives(r)[1]))
...
print('s_delta = {0:9.5g}'.format(delta_spl.derivatives(r)[1]*r/sqrt(1-float(delta_spl(r))**2)))
...
print('Gradient conversion omt(rho_tor) -> a/LT; factor = {0:9.5g}'.format(r_avg[-1]*(rho_tor_spl.derivatives(psi)[1]/ravg_spl.derivatives(psi)[1])))
print('Gradient conversion omt(rho_tor) -> R/LT; factor = {0:9.5g}'.format(R0_pos*(rho_tor_spl.derivatives(psi)[1]/ravg_spl.derivatives(psi)[1])))
