...
int main(int argc, char **argv){
  ...
  coupler::Array1d<int>* xgc_numsurf = coupler::receive_gene_pproc<int>(dir, h8.IO, h8.eng, "xgc_numsurf");
  coupler::Array1d<int>* xgc_znum = coupler::receive_gene_pproc<int>(dir, h9.IO, h9.eng, "xgc_znum");
  coupler::Array1d<double>* xgc_xcoords = coupler::receive_gene_pproc<double>(dir, h10.IO, h10.eng, "xgc_xcoords");
