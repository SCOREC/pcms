...
module wdmcpl
 ...
 public :: wdmcpl_kokkos_initialize_without_args
 public :: wdmcpl_kokkos_finalize
...
function swigc_wdmcpl_create_xgc_field_adapter(farg1, farg2, farg3, farg4, farg5, farg6, farg7) &
...
subroutine swigc_wdmcpl_kokkos_initialize_without_args() &
bind(C, name="_wrap_wdmcpl_kokkos_initialize_without_args")
use, intrinsic :: ISO_C_BINDING
end subroutine

subroutine swigc_wdmcpl_kokkos_finalize() &
bind(C, name="_wrap_wdmcpl_kokkos_finalize")
use, intrinsic :: ISO_C_BINDING
end subroutine
...
function wdmcpl_create_xgc_field_adapter(name, plane_comm, data, size, data_type, rc, in_overlap) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
fresult = swigc_wdmcpl_create_xgc_field_adapter(farg1, farg2, farg3, farg4, farg5, farg6, farg7)
swig_result%swigdata = fresult
end function
...
subroutine wdmcpl_kokkos_initialize_without_args()
use, intrinsic :: ISO_C_BINDING

call swigc_wdmcpl_kokkos_initialize_without_args()
end subroutine

subroutine wdmcpl_kokkos_finalize()
use, intrinsic :: ISO_C_BINDING

call swigc_wdmcpl_kokkos_finalize()
end subroutine
