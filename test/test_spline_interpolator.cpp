             ...
             Kokkos::View<double*, HostMemorySpace> res_1d)
{
  ...
  Kokkos::View<double*, TestMemorySpace> splinv_view("splinv_view", static_cast<std::size_t>(3) * nt);
             ...
             Kokkos::View<double*, HostMemorySpace> res_2d)
{
  ...
  Kokkos::View<double*, TestMemorySpace> values_view("values_view", static_cast<std::size_t>(nth) * nx);
  Kokkos::parallel_for(
