...
module par_in
  ...
  Character(len=FILENAME_MAX):: diagdir
  Character(len=FILENAME_MAX):: chptdir
  Logical:: write_h5=.false.
  Logical:: write_hac=.false.
  Logical:: write_std=.true.

  character(len=FILENAME_MAX) :: ADIOS_XML = ''
  integer:: ADIOS_MPI_AGG=496
  integer:: ADIOS_MPI_OST=248

  !coupling
  integer :: acm_log_lvl=2
  logical :: acm_timing=.false.
  character(len=FILENAME_MAX) :: nmldir = 'namelists'
