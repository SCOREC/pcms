...
int fu_fsize_(const char *file, unsigned int l)
{
...
void fu_ftos_(const char *file, int *s, char *buf)
{
...
void fu_stof_(const char *file, int *s, char *buf)
{
...
void fu_stostdout_(int *s, char *buf)
{
